	...
	public static void quiz() {
		 ...
		 */
			...
			for (int i = 0; i < question.length; i++) {
				...
				////tryの位置をここに変更する可能性がある。
				while(true) {
					try {
						String input = ThrowExceptionUtil.inputValue();
					////
						num = Integer.parseInt(input);////int num = は、後半のnumがスコープ外ということでエラーが起きる。
						break;////elseが無かったので、ここでbreak;を入れる必要があった。
					}catch(IOException e) {
...
////////udemy Java基礎 throwsキーワードって何？の項を参照すべし
